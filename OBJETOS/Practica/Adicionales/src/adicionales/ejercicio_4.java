...
public class ejercicio_4 {
    ...
    public static void main(String[] args) {
        ...
        d1=new Director(31, "dir 1", 111, 41);
        d2=new Director(32, "dir 2", 222, 42);
        
        s=new Semicircular("sons", d1, 3);
        
        h= new Por_hileras(2, 2, "petisos", d2);
        ...
        for(int i=0; i<3; i++){
            ...
            System.out.println("ingrese un tono: ");
            tono= Lector.leerInt();
        ...
        System.out.println(s.coroLleno());
        System.out.println(s.bienOrdenado());
        System.out.println(h);
        System.out.println(h.coroLleno());
        System.out.println(h.bienOrdenado());
    }
