...
A- Implemente la jerarquía de clases declarando atributos,
métodos para obtener/modificar su valor y constructores que reciban los datos necesarios.
...
public class ejercicio_2 {
    ...
    public static void main(String[] args) {
        ...
        String nombre;
        double sueldo, antigüedad;
        int campeonatos, goles, partidos;
        
        nombre=GeneradorAleatorio.generarString(10);
        System.out.println(nombre);
        sueldo=GeneradorAleatorio.generarDouble(10000);
        System.out.println(sueldo);
        antigüedad=GeneradorAleatorio.generarDouble(10);
        System.out.println(antigüedad);
        campeonatos=GeneradorAleatorio.generarInt(10);
        System.out.println(campeonatos);
        
        Entrenador e = new Entrenador ( campeonatos,  nombre,  sueldo,  antigüedad);
        ...
        antigüedad=GeneradorAleatorio.generarDouble(10);
        System.out.println(antigüedad);
        goles=GeneradorAleatorio.generarInt(10);
        System.out.println(goles);
        partidos=GeneradorAleatorio.generarInt(10);
        System.out.println(partidos);
        
        Jugador j = new Jugador ( partidos,  goles,  nombre,  sueldo,  antigüedad);
